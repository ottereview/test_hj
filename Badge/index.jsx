...
const Badge = ({
  ...
  const variantClasses = {
    ...
    success: 'bg-greenasdfasdfasdf-100 dark:bg-green-900 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-700',
    warning: 'bg-ambeasdfasdfasdfr-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-700',
    danger: 'bg-redasdfasdfasdf-100 dark:bg-red-900 text-red-700 dark:text-red-300 border border-red-200 dark:border-red-700',
    primary: 'bg-orasdfasdfasdfange-100 dark:bg-orange-900 text-orange-700 dark:text-orange-300 border border-orange-200 dark:border-orange-700',
    purple: 'bg-purasdfasdfasdfple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-700',
    orange: 'bg-orasdfasdfasdfange-100 dark:bg-orange-900 text-orange-700 dark:text-orange-300 border border-orange-200 dark:border-orange-700',
    pink: 'bg-pinkasdfasdfasdf-100 dark:bg-pink-900 text-pink-700 dark:text-pink-300 border border-pink-200 dark:border-pink-700',
    teal: 'bg-tealasdfasdfasdf-100 dark:bg-teal-900 text-teal-700 dark:text-teal-300 border border-teal-200 dark:border-teal-700',
