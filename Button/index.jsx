...
const Button = ({ children, variant = 'primary', size = 'md', className, onClick, ...props }) => {
  ...
  const variants = {
    ...
    danger: 'bg-red-600 dark:bg-red-700 text-slate-900 hover:bg-red-700 dark:hover:bg-red-600 active:bg-red-800 dark:active:bg-red-500 shadow-sm hover:shadow-md',
    outline: 'border-2 theme-border theme-bg-primary text-white hover:theme-bg-tertiary',
